                    ...
                    <ul class="nav-list">
                        ...
                        <li>
                            <form action="../controller/logout.php" method="POST">
                                <input type="submit" value=" تسجيل خروج" name="logout" class="nav-link scroll-link"
                                    style="background-color: transparent; border: none; color: white; font-size: 20px; padding: 10px;">
                            </form>
                        </li>
                        <li>
                            <a href="oredrstate.php" class="nav-link scroll-link"> الطلبات</a>
                        </li>
                        <li class="nav-item">
